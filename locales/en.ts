...
export const en = {
  ...
  'copy.plain': 'Copy',
  'copy.minified': 'Copy minified',
  'copy.shareTo': 'Copy for',
  'copy.telegram': 'Telegram',
  'copy.telegram.hint': 'Pastes as a code block in a chat',
  'copy.telegram.tooLong': 'Heads up: Telegram limits messages to 4,096 characters — send it as a file instead.',
  'copy.markdown': 'Discord / GitHub (Markdown)',
  'copy.markdown.hint': 'Code block with syntax highlighting',
  'copy.slack': 'Slack',
  'copy.slack.hint': 'Code block without language tag',
  'copy.email': 'Email / Word',
  'copy.email.hint': 'Keeps monospace formatting when pasted',
  'copy.escaped': 'Escaped string',
  'copy.escaped.hint': 'Quoted string literal for code',
  'copy.done': 'Copied: {format}',
